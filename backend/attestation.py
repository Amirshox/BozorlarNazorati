...
class Attestation:
    ...
    def _decrypt_integrity_token(self) -> Optional[Dict]:
        ...
        try:
            ...
            response = service.v1().decodeIntegrityToken(packageName=self.package_name, body=data).execute()
    ...
    def verify_online(self, nonce: Optional[str] = None) -> bool:
        ...
        verdicts.append("MEETS_DEVICE_INTEGRITY" in deviceIntegrity.get("deviceRecognitionVerdict", []))
        return all(verdicts)
